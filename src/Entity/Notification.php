...
class Notification
{
	...
	#[ORM\ManyToOne(inversedBy: 'notificationChallengeMessages')]
                           	private ?ChallengeMessage $challengeMessage = null;

	#[ORM\ManyToOne(inversedBy: 'notificationChallengeResponse')]
                           	private ?Publication $challengeResponse = null;

	#[ORM\ManyToOne(inversedBy: 'notificationAssignChallenges')]
                           	private ?Challenge $assignChallenge = null;

	#[ORM\ManyToOne(inversedBy: 'notificationAssignChallengeMessages')]
                           	private ?ChallengeMessage $assignChallengeMessage = null;

	#[ORM\ManyToOne(inversedBy: 'notificationChallengeLikes')]
                           	private ?ChallengeMessage $likeChallenge = null;

    #[ORM\ManyToOne(inversedBy: 'notificationChallengeMessageReply')]
    private ?ChallengeMessage $challengeMessageReply = null;

    #[ORM\ManyToOne(inversedBy: 'notifcationPublicationChapterBookmark')]
    private ?PublicationBookmark $publicationChapterBookmark = null;

    #[ORM\ManyToOne(inversedBy: 'notifications')]
    private ?PublicationAnnotationReply $annotationReply = null;
	...
	public function getChallengeMessage(): ?ChallengeMessage
                           	{
                           		return $this->challengeMessage;
                           	}

	public function setChallengeMessage(?ChallengeMessage $challengeMessage): self
                           	{
	...
	public function getChallengeResponse(): ?Publication
                           	{
                           		return $this->challengeResponse;
                           	}

	public function setChallengeResponse(?Publication $challengeResponse): self
                           	{
	...
	public function getAssignChallenge(): ?Challenge
                           	{
                           		return $this->assignChallenge;
                           	}

	public function setAssignChallenge(?Challenge $assignChallenge): self
                           	{
	...
	public function getAssignChallengeMessage(): ?ChallengeMessage
                           	{
                           		return $this->assignChallengeMessage;
                           	}

	public function setAssignChallengeMessage(?ChallengeMessage $assignChallengeMessage): self
                           	{
                           		$this->assignChallengeMessage = $assignChallengeMessage;
                           
                           		return $this;
                           	}

	public function getLikeChallenge(): ?ChallengeMessage
                           	{
                           		return $this->likeChallenge;
                           	}

	public function setLikeChallenge(?ChallengeMessage $likeChallenge): self
                           	{
    ...
    public function getChallengeMessageReply(): ?ChallengeMessage
    {
        return $this->challengeMessageReply;
    }

    public function setChallengeMessageReply(?ChallengeMessage $challengeMessageReply): self
    {
        $this->challengeMessageReply = $challengeMessageReply;

        return $this;
    }

    public function getPublicationChapterBookmark(): ?PublicationBookmark
    {
        return $this->publicationChapterBookmark;
    }

    public function setPublicationChapterBookmark(?PublicationBookmark $publicationChapterBookmark): self
    {
        $this->publicationChapterBookmark = $publicationChapterBookmark;

        return $this;
    }

    public function getAnnotationReply(): ?PublicationAnnotationReply
    {
        return $this->annotationReply;
    }

    public function setAnnotationReply(?PublicationAnnotationReply $annotationReply): self
    {
