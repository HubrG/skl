...
export function quillEditorForum() {
  if (!document.getElementById("editorForum")) {
    return;
  }
  var toolbarOptions = [
  ...
  if (document.getElementById("editorForum")) {
    const quill = new Quill("#editorForum", options);
    ...
    //
    quill.root.innerHTML = document.getElementById("editorHTMLForum").value;
    ...
    // document.getElementById("editorForum").addEventListener("click", (e) => {
...
if (document.getElementById("editorHTMLForum")) {
  const quillContainer = document.querySelector("#editorForum");
