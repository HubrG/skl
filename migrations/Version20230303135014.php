 ...
 */
final class Version20230303135014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CA9B52D52B FOREIGN KEY (publication_follow_id) REFERENCES publication_chapter (id)');
