 ...
 */
final class Version20230203132527 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649CDA6D589 FOREIGN KEY (publication_chapter_comment_like_id) REFERENCES publication_chapter_comment_like (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
